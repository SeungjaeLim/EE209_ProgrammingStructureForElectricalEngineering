...
TestStrCopy()
{
  ...
  const char str_empty1[] = "";

  char dest[MAX_SIZE];
  char answer[MAX_SIZE];
  char ans1[MAX_SIZE] = "abc";
  char ans2[MAX_SIZE] = "abc";
  char *res1, *res2;
  ...
  printf("\nTest3:\n");
  res1 = StrCopy(dest, str_empty1);
  res2 = strcpy(answer, str_empty1);
...
/* Test3: Copy the empty string */
  printf("\nTest4:\n");
  res1 = StrCopy(ans1, str_empty1);
  res2 = strcpy(ans2, str_empty1);
  ...
  /* Test3: Copy the empty string */
  printf("\nTest4:\n");
  res1 = StrCopy(ans1, str2);
  res2 = strcpy(ans2, str2);
...
TestStrFindStr()
{
  ...
  printf("\nTest6:\n");     
  res1 = StrFindStr(str_empty, str2);
  res2 = strstr(str_empty, str2);
  ...
  printf("\nTest7:\n");     
  res1 = StrFindStr(str_empty, str_empty2);
  res2 = strstr(str_empty, str_empty2);
...
TestStrConcat()
{
  ...
  printf("\nTest5:\n");
  res1 = StrConcat(dest5, str_empty);
  res2 = strcat(answer5, str_empty);
...
TestStrFindChr()
{
  ...
  printf("Test5:\n");
  res1 = StrFindChr(str3, 'a');
  res2 = strchr(str3, 'a');
  PRINT_RESULT(res1 == res2);
  printf("Your      Answer: %p\n", res1);
  printf("String.h  Answer: %p\n", res2);
